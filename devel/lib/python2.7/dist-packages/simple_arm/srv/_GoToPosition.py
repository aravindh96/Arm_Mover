...
class GoToPositionRequest(genpy.Message):
  _md5sum = "1464c55039e16844dece818b4f76d730"
  _type = "simple_arm/GoToPositionRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64 joint_1_position
float64 joint_2_position
"""
  __slots__ = ['joint_1_position','joint_2_position']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       joint_1_position,joint_2_position
    ...
    if args or kwds:
      ...
      if self.joint_1_position is None:
        self.joint_1_position = 0.
      if self.joint_2_position is None:
        self.joint_2_position = 0.
    else:
      self.joint_1_position = 0.
      self.joint_2_position = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2d().pack(_x.joint_1_position, _x.joint_2_position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.joint_1_position, _x.joint_2_position,) = _get_struct_2d().unpack(str[start:end])
      return self
...
class GoToPosition(object):
  ...
  _md5sum = '2cfecef4f6d375467fcd431fdce02c32'
