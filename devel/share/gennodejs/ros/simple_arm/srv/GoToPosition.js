...
class GoToPositionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.joint_1_position = null;
      this.joint_2_position = null;
    }
    else {
      if (initObj.hasOwnProperty('joint_1_position')) {
        this.joint_1_position = initObj.joint_1_position
      }
      else {
        this.joint_1_position = 0.0;
      }
      if (initObj.hasOwnProperty('joint_2_position')) {
        this.joint_2_position = initObj.joint_2_position
      }
      else {
        this.joint_2_position = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [joint_1_position]
    bufferOffset = _serializer.float64(obj.joint_1_position, buffer, bufferOffset);
    // Serialize message field [joint_2_position]
    bufferOffset = _serializer.float64(obj.joint_2_position, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [joint_1_position]
    data.joint_1_position = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [joint_2_position]
    data.joint_2_position = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.joint_1_position !== undefined) {
      resolved.joint_1_position = msg.joint_1_position;
    }
    else {
      resolved.joint_1_position = 0.0
    }

    if (msg.joint_2_position !== undefined) {
      resolved.joint_2_position = msg.joint_2_position;
    }
    else {
      resolved.joint_2_position = 0.0
    }
...
module.exports = {
  ...
  md5sum() { return '2cfecef4f6d375467fcd431fdce02c32'; },
